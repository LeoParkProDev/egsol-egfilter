...
export const products: Product[] = [
  {
    ...
    faqs: [
      ...
      {
        q: "원하는 크기로 제작이 가능한가요?",
        a: "네. 300×300부터 610×610mm 표준 규격 외에도 현장 설비에 맞춘 커스텀 제작이 가능합니다. 기존 필터 실측 치수(가로×세로×두께)를 보내주시면 당일 견적을 드립니다.",
      },
    ],
  },
  {
    ...
    faqs: [
      {
        ...
        a: "EN 1822 기준 H13은 99.95%, H14는 99.995% 이상의 포집 효율입니다. 수술실 급기 최종단·고청정 클린룸은 H14, 시술실·병동·일반 클린룸은 H13이 통용되는 기준입니다. 용도를 알려주시면 등급을 제안해 드립니다.",
      },
      {
        q: "헤파필터는 세척해서 재사용할 수 있나요?",
        a: "불가능합니다. 유리섬유 여재는 물이나 충격에 손상되어 여과 성능을 잃고, 눈에 보이지 않는 손상이 누설로 이어집니다. 차압이 초기 대비 2배 수준에 도달하면 교체하는 것이 원칙입니다.",
      },
      {
        q: "병원 수술실용으로 규격 맞춤 제작이 되나요?",
        a: "네. 610×610, 305×610mm 표준 외에 안과·성형외과 소형 수술실의 비표준 규격도 맞춤 제작합니다. 기존 필터 라벨 사진을 보내주시면 동일 규격·개스킷 사양으로 제작해 당일 견적을 드립니다.",
      },
    ],
  },
  {
    ...
    faqs: [
      ...
      {
        q: "F7과 F9의 차이는 무엇인가요?",
        a: "숫자가 클수록 여과 효율이 높습니다. F7은 일반 공조의 표준적 선택이고, F9는 헤파필터 전단 보호용이나 더 높은 실내 공기질이 필요한 현장에 사용합니다. 후단 헤파 유무에 따라 권장 등급이 달라집니다.",
      },
    ],
  },
  {
    ...
    faqs: [
      ...
      {
        q: "두께는 어떤 기준으로 선택하나요?",
        a: "일반 흡배기구·공조기 프리필터 용도는 10mm, 도장부스 천장·바닥처럼 분진 부하가 큰 곳은 15~20mm를 권장합니다. 용도를 알려주시면 두께와 폭을 제안해 드립니다.",
      },
      {
        q: "대량 구매 시 할인이 되나요?",
        a: "네. 롤 단위 대량 구매와 정기 납품 계약 시 단가 할인이 적용됩니다. 사용량과 규격을 알려주시면 견적서를 보내드립니다.",
      },
    ],
  },
];
