...
const steps = [
  ...
  {
    title: "당일 견적 + 등급 제안",
    desc: "규격 확인 후 진료과에 맞는 등급·수량·프레임 옵션별 견적서를 당일 회신합니다. 세금계산서 발행.",
    time: "저희 소요 시간 — 당일",
  },
  {
...
const faqs = [
  ...
  {
    q: "세금계산서 발행과 병원 행정 절차 대응이 가능한가요?",
    a: "네. 사업자 거래로 세금계산서를 발행하며, 견적서·거래명세서 등 병원 행정에 필요한 서류를 함께 준비해 드립니다. 데스크(실장님)와 직접 진행하실 수 있습니다.",
  },
];
      ...
      <section className="bg-white py-20 md:py-28">
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="mt-11 max-w-2xl border-[1.5px] border-dashed border-brand-green/50 rounded-2xl px-8 py-6 text-gray-500">
            ...
            규격 확인부터 행정 서류(견적서·거래명세서·세금계산서)까지 데스크와 직접 진행
            가능하도록 안내해 드립니다.
          </div>
        </div>
      </section>
